...
exports.commentController = exports.tagController = exports.clientController = exports.chatController = exports.socialController = exports.blogController = exports.adminController = exports.userController = void 0;
...
const CommentUseCase_1 = require("../../useCases/CommentUseCase");
...
const tagController_1 = require("../../providers/controllers/tagController");
const commentController_1 = require("../../providers/controllers/commentController");
...
const blogUseCase = new BlogUseCase_1.BlogPostUseCase(blogRepository, s3, reactionReopository, notificationRepository);
const blogController = new blogController_1.BlogController(blogUseCase);
exports.blogController = blogController;
const tagController = new tagController_1.TagController(blogUseCase);
...
const commentUseCase = new CommentUseCase_1.CommentUseCase(blogRepository, notificationRepository, commentRepository);
const commentController = new commentController_1.CommentController(commentUseCase);
